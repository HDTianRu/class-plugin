...
ok(ret.courses.find((c) => c.CourseName === '大学物理B（二）').Tag === '', '"未到" 不显示标签')
...
ok(day.courses[0].Time === '20:50~21:45', '11-12 节时间文本')
ok(Class.timeText(3, 4) === '10:00~10:55', '3-4 节时间文本')
ok(Class.timeText(13, 14) === '', '超出作息表返回空串')
